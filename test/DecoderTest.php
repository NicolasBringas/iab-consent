...
final class DecoderTest extends TestCase
{
	...
	public function testDecode()
	{
		...
		$compareWith = [
			...
			'maxVendorId' => 45811,
			'created' => new DateTime("2018-05-23T07:58:14.000Z"),
			'lastUpdated' => new DateTime("2018-05-24T12:47:40.000Z"),
		...
		$this->assertEquals($compareWith, $consentData2);
		$this->assertEquals($compareWith, $consentData3);
	}
}